...
class BLM {
     ...
     * @param {*} filter Filter lines with words present.
     */
    ...
    /**
     * Replace old word in line with new word
     *
     * Maintain capitalization of word
     *
     * @param {*} line The line to replace
     * @param {*} oldWord Old word present in line
     * @param {*} newWord New word to replace with
     * @return {*} line with replaced word
     */
    ...
    /**
     * Interactive prompt to replace words in a line.
     * @param {*} line
     * @param {*} wordsInLine
     */
    ...
    /**
     * Replace words in a line without an interactive prompt
     *
     * @param {*} line
     * @param {*} wordsInLine
     * @return {*} line with replaced word
    ...
    /**
     * Setup words file inside class instance.
     */
    ...
    /**
     * Setup file paths from dir/file received from user.
     */
    ...
    /**
     * Replace words in give file path, either interactively or not.
     *
     * @param {*} fPath
     * @param {*} ignorePrompt
     */
     ...
     *
     * @param {*} wordsFile The file to use which contains the replacement word.
     ...
     * @param {*} ignorePrompt Whether prompt is shown while replacement is done
     * @return {*} replaced file contents
     */
    async replace() {
    ...
    /**
     * Replace words in file interactively
     */
    ...
    /**
     * Print summary of inappropriate words in given file paths.
     *
     * Dumps summary.json.
     */
    async printSummary() {
        ...
        for (const fPath of this.filePaths) {
            const lines = await this._getLinesFromFile(fPath);
    ...
    /**
     * Dump results.json with detailed view of inappriate words on every line.
     *
     * @param {*} verbose Whether to show the actual line in the dumped file.
     */
